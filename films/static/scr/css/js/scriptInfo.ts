...
function displayFilm(films: Film[]) {
    let allFilms = document.getElementById("allFilms");
    while (allFilms?.firstChild) {
    ...
    for (let i: number = 0; i < films.length; i++) {
        if (films[i].info == true){
            ...
            if (films[i].review.length == 0) {
                ...
                for (let k: number = 0; k < films[i].review.length; k++) {
            ...
            add_rev_btn.addEventListener('click', () => {
                ...
                add_btn.addEventListener('click', () => {
                    let name_input_input = <HTMLInputElement>document.getElementById("rev_name");
                    let name_value = name_input_input.value;

                    let text_input_input = <HTMLInputElement>document.getElementById("rev_text");
                    let text_value = text_input_input.value;

                    let mark_input_input = <HTMLInputElement>document.getElementById("rev_mark");
