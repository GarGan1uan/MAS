"use strict";
function filter() {
    let search = document.getElementById("1");
    ...
    // --------------------------------------------------- ЖАНРЫ -------------------------------------------------
    let genres = document.getElementById("2");
    let genres_value = [];
    ...
    for (let i = 0; i < films.length; i++) {
        ...
        for (let j = 0; j < films[i].genres.length; j++) {
            for (let k = 0; k < genres_value.length; k++) {
    ...
    // --------------------------------------------------- РЭЙТИНГ -------------------------------------------------
    let age = document.getElementById("3");
    let age_value = [];
    ...
    // --------------------------------------------------- Страна -------------------------------------------------
    let country = document.getElementById("4");
    let country_value = [];
    ...
    for (let i = 0; i < films.length; i++) {
        let count = 0;
        for (let k = 0; k < country_value.length; k++) {
    ...
    // --------------------------------------------------- Год -------------------------------------------------
    let year = document.getElementById("5");
    let year_value = [];
    ...
    for (let i = 0; i < films.length; i++) {
        let count = 0;
        for (let k = 0; k < year_value.length; k++) {
            if ((String)(films[i].release) == year_value[k]) {
                count++;
            }
            if ((Number)(films[i].release) < 2015) {
                if ((Number)(films[i].release) >= 2010 && year_value[k] == "2010")
                    count++;
                else if ((Number)(films[i].release) >= 2000 && year_value[k] == "2000")
                    count++;
                else if ((Number)(films[i].release) >= 1990 && year_value[k] == "1990")
                    count++;
                else if ((Number)(films[i].release) >= 1980 && year_value[k] == "1980")
                    count++;
            }
        }
